...
public class Instantiation  implements CommandLineRunner{
	...
	public void run(String... args) throws Exception {
		...
		Post post1 = new Post(null, sdf.parse("15/10/2024"), "Partiu viagem!", "Vou viajar para o nordeste, enfim férias!", maria);
		Post post2 = new Post(null, sdf.parse("14/10/2024"), "Bom dia!", "Está um belo dia hoje!", maria);
